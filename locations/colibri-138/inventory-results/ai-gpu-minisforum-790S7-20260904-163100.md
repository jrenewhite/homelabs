...
- **Collected at:** `2026-09-04T16:31:52-06:00`

---

# Host Inventory

- **Audit timestamp:** 2026-09-04T22:31:52+00:00
...
```text
 Static hostname: ai-gpu
       Icon name: computer-desktop
         Chassis: desktop 🖥️
      Machine ID: ed765dc2c1b540708778e36c7211adb7
         Boot ID: bc8b94f60c3f4cada873850d6bc87b0e
...
```text
Linux ai-gpu 7.0.0-27-generic #27-Ubuntu SMP PREEMPT_DYNAMIC Thu Jun 18 19:13:49 UTC 2026 x86_64 GNU/Linux
```
...
Mem:            45Gi       1.4Gi        41Gi       1.6Mi       3.0Gi        44Gi
Swap:          8.0Gi          0B       8.0Gi

MemTotal:       47965532 kB
MemAvailable:   46482540 kB
...
enp4s0           UP             192.168.0.13/24 metric 100 fe80::5a47:caff:fe7f:84b5/64 
tailscale0       UNKNOWN        100.112.160.103/32 fd7a:115c:a1e0::3a32:a067/128 fe80::5f53:eaa3:1d9d:ad7f/64 
```
...
enp4s0           UP             58:47:ca:7f:84:b5 <BROADCAST,MULTICAST,UP,LOWER_UP> 
...
1.1.1.1 via 192.168.0.1 dev enp4s0 proto dhcp src 192.168.0.13 metric 100 
...
192.168.0.14 dev enp4s0 proto dhcp scope link src 192.168.0.13 metric 100 
```

### Neighbour table

```text
192.168.0.206 dev enp4s0 lladdr 40:1a:58:4a:d3:68 DELAY 
192.168.0.1 dev enp4s0 lladdr cc:ba:bd:d2:21:98 REACHABLE 
192.168.0.37 dev enp4s0 lladdr 98:25:4a:4f:2b:f0 STALE 
192.168.0.36 dev enp4s0 lladdr 98:25:4a:4f:2b:1c STALE 
192.168.0.38 dev enp4s0 lladdr 98:25:4a:4e:ee:50 STALE 
192.168.0.14 dev enp4s0 lladdr c0:74:2b:fc:59:86 STALE 
192.168.0.203 dev enp4s0 lladdr c0:e5:da:7c:b2:2a STALE 
192.168.0.10 dev enp4s0 FAILED 
```
...
nvme0n1     /dev/nvme0n1   disk 119.2G ORICO               OAS3IR23LFILA392L3I9 nvme      0                                                                             
├─nvme0n1p1 /dev/nvme0n1p1 part     1G                                          nvme      0 vfat   FAT32       EFC2-A35F                            /boot/efi        1G     1%
└─nvme0n1p2 /dev/nvme0n1p2 part 118.2G                                          nvme      0 ext4   1.0         3aa7996e-96ee-4251-9378-63865bda3961 /               97G    11%
nvme1n1     /dev/nvme1n1   disk 931.5G KINGSTON SNV3S1000G 50026B76871B3387     nvme      0 ext4   1.0         4cac2287-d81a-40d7-801e-829c211fe3a2 /storage     869.2G     0%
```

### Filesystem identifiers

```text
/dev/nvme0n1p2: UUID="3aa7996e-96ee-4251-9378-63865bda3961" BLOCK_SIZE="4096" TYPE="ext4" PARTUUID="f5ebdee9-31b2-4312-9edc-e45cc57bcc45"
/dev/nvme0n1p1: UUID="EFC2-A35F" BLOCK_SIZE="512" TYPE="vfat" PARTUUID="05244ccd-5191-4a28-ab0c-46bfc59b90d6"
```
...
├─/run                                        tmpfs          tmpfs       rw,nosuid,nodev,size=9593108k,nr_inodes=819200,mode=755,inode64
│ ├─/run/user/1000                            tmpfs          tmpfs       rw,nosuid,nodev,relatime,size=4796552k,nr_inodes=1199138,mode=700,uid=1000,gid=1000,inode64
...
├─/dev                                        devtmpfs       devtmpfs    rw,nosuid,size=23870576k,nr_inodes=5967644,mode=755,inode64
...
├─/tmp                                        tmpfs          tmpfs       rw,nosuid,nodev,size=23982768k,nr_inodes=1048576,inode64,usrquota
├─/proc                                       proc           proc        rw,nosuid,nodev,noexec,relatime
│ └─/proc/sys/fs/binfmt_misc                  systemd-1      autofs      rw,relatime,fd=35,pgrp=1,timeout=0,minproto=5,maxproto=5,direct,pipe_ino=20658
│   └─/proc/sys/fs/binfmt_misc                binfmt_misc    binfmt_misc rw,nosuid,nodev,noexec,relatime
├─/storage                                    /dev/nvme1n1   ext4        rw,relatime
...
/dev/nvme1n1   ext4      916G  2.1M  870G   1% /storage
...
Fri 2026-09-04 22:40:00 UTC     7min Fri 2026-09-04 22:30:23 UTC 2min 31s ago sysstat-collect.timer          sysstat-collect.service
Fri 2026-09-04 23:47:47 UTC 1h 14min Fri 2026-09-04 22:08:37 UTC    24min ago fwupd-refresh.timer            fwupd-refresh.service
Sat 2026-09-05 00:00:00 UTC 1h 27min Fri 2026-09-04 00:00:25 UTC      22h ago dpkg-db-backup.timer           dpkg-db-backup.service
Sat 2026-09-05 00:00:00 UTC 1h 27min Fri 2026-09-04 00:00:25 UTC      22h ago sysstat-rotate.timer           sysstat-rotate.service
Sat 2026-09-05 00:07:00 UTC 1h 34min Fri 2026-09-04 00:07:37 UTC      22h ago sysstat-summary.timer          sysstat-summary.service
Sat 2026-09-05 00:28:32 UTC 1h 55min Fri 2026-09-04 00:23:47 UTC      22h ago logrotate.timer                logrotate.service
Sat 2026-09-05 00:41:29 UTC  2h 8min Fri 2026-09-04 21:07:40 UTC 1h 25min ago motd-news.timer                motd-news.service
Sat 2026-09-05 06:08:33 UTC       7h Fri 2026-09-04 06:59:36 UTC      15h ago apt-daily-upgrade.timer        apt-daily-upgrade.service
Sat 2026-09-05 11:33:31 UTC      13h Fri 2026-09-04 01:20:07 UTC      21h ago man-db.timer                   man-db.service
Sat 2026-09-05 11:36:36 UTC      13h Fri 2026-09-04 22:32:50 UTC       5s ago apt-daily.timer                apt-daily.service
Sat 2026-09-05 20:14:10 UTC      21h Fri 2026-09-04 20:14:10 UTC 2h 18min ago update-notifier-download.timer update-notifier-download.service
Sat 2026-09-05 20:23:19 UTC      21h Fri 2026-09-04 20:23:19 UTC  2h 9min ago systemd-tmpfiles-clean.timer   systemd-tmpfiles-clean.service
Sun 2026-09-06 03:10:43 UTC 1 day 4h Sun 2026-08-30 03:11:35 UTC   5 days ago e2scrub_all.timer              e2scrub_all.service
Sun 2026-09-06 03:10:55 UTC 1 day 4h Sun 2026-08-30 03:10:13 UTC   5 days ago xfs_scrub_all.timer            xfs_scrub_all.service
Mon 2026-09-07 00:20:41 UTC   2 days Mon 2026-08-31 00:22:52 UTC   4 days ago fstrim.timer                   fstrim.service
Fri 2026-09-11 06:25:16 UTC   6 days Wed 2026-09-02 06:13:50 UTC   2 days ago update-notifier-motd.timer     update-notifier-motd.service
...
tcp   LISTEN 0      4096               100.112.160.103:63824      0.0.0.0:*          
tcp   LISTEN 0      4096   [fd7a:115c:a1e0::3a32:a067]:41214         [::]:*          
...
drwxr-xr-x 112 root root 4096 Sep  4 22:32 ..
