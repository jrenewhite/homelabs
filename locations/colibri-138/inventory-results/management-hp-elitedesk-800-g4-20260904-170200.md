# Homelab Inventory: 192.168.0.10

- **Requested target:** `192.168.0.10:22`
- **SSH user:** `jrenewhite`
- **Collector:** `homelab-inventory.sh 1.0.0`
- **Collected at:** `2026-09-04T17:02:02-06:00`

---

# Host Inventory

- **Audit timestamp:** 2026-09-04T23:02:01+00:00
...
primary_mac=c4:65:16:ac:ab:37
primary_ipv4=192.168.0.10
```
...
```text
 Static hostname: management-plane
       Icon name: computer-desktop
         Chassis: desktop 🖥️
      Machine ID: af08f8165def4b55951c9156e63d486c
         Boot ID: b4a4c7eee8574c84b10dc32be8268290
Operating System: Ubuntu 26.04.1 LTS
          Kernel: Linux 7.0.0-30-generic
    Architecture: x86-64
 Hardware Vendor: HP
  Hardware Model: HP EliteDesk 800 G4 DM 35W _TAA_
    Hardware SKU: 5CN60US#ABA
...
```text
sys_vendor        : HP
product_name      : HP EliteDesk 800 G4 DM 35W (TAA)
...
Mem:            10Gi       664Mi       9.7Gi       1.7Mi       867Mi        10Gi
Swap:          4.0Gi          0B       4.0Gi

MemTotal:       11489020 kB
MemAvailable:   10809084 kB
...
eno1             UP             192.168.0.10/24 metric 100 fe80::c665:16ff:feac:ab37/64 
```
...
eno1             UP             c4:65:16:ac:ab:37 <BROADCAST,MULTICAST,UP,LOWER_UP> 
```

### Routing table

```text
default via 192.168.0.1 dev eno1 proto dhcp src 192.168.0.10 metric 100 
1.1.1.1 via 192.168.0.1 dev eno1 proto dhcp src 192.168.0.10 metric 100 
192.168.0.0/24 dev eno1 proto kernel scope link src 192.168.0.10 metric 100 
192.168.0.1 dev eno1 proto dhcp scope link src 192.168.0.10 metric 100 
192.168.0.14 dev eno1 proto dhcp scope link src 192.168.0.10 metric 100 
```
...
192.168.0.11 dev eno1 lladdr c8:ff:bf:05:f4:46 REACHABLE 
192.168.0.1 dev eno1 lladdr cc:ba:bd:d2:21:98 REACHABLE 
192.168.0.37 dev eno1 lladdr 98:25:4a:4f:2b:f0 STALE 
192.168.0.12 dev eno1 lladdr 58:47:ca:79:08:69 REACHABLE 
192.168.0.38 dev eno1 lladdr 98:25:4a:4e:ee:50 STALE 
192.168.0.13 dev eno1 lladdr 58:47:ca:7f:84:b5 REACHABLE 
...
nvme0n1     /dev/nvme0n1   disk 238.5G WD PC SN810 SDCPNRY-256G-1006 220951802057 nvme      0                                                                             
├─nvme0n1p1 /dev/nvme0n1p1 part     1G                                            nvme      0 vfat   FAT32       4E6B-F796                            /boot/efi        1G     1%
└─nvme0n1p2 /dev/nvme0n1p2 part 237.4G                                            nvme      0 ext4   1.0         86375aa7-574b-41e8-a8c0-086945533e1d /            212.4G     4%
```
...
├─/run                                        tmpfs                  tmpfs       rw,nosuid,nodev,size=2297804k,nr_inodes=819200,mode=755,inode64
...
│ ├─/run/snapd/ns                             tmpfs[/snapd/ns]       tmpfs       rw,nosuid,nodev,size=2297804k,nr_inodes=819200,mode=755,inode64
│ │ └─/run/snapd/ns/lxd.mnt                   nsfs[mnt:[4026532320]] nsfs        rw
│ └─/run/media/.lxd-shmounts                  tmpfs                  tmpfs       rw,relatime,size=1024k,mode=711,inode64
├─/tmp                                        tmpfs                  tmpfs       rw,nosuid,nodev,size=5744512k,nr_inodes=1048576,inode64,usrquota
...
├─/dev                                        devtmpfs               devtmpfs    rw,nosuid,size=4326824k,nr_inodes=1081706,mode=755,inode64
...
│ └─/proc/sys/fs/binfmt_misc                  systemd-1              autofs      rw,relatime,fd=35,pgrp=1,timeout=0,minproto=5,maxproto=5,direct,pipe_ino=8693
...
└─/var/snap/lxd/common/ns                     tmpfs                  tmpfs       rw,relatime,size=1024k,mode=700,inode64
  └─/var/snap/lxd/common/ns/shmounts          nsfs[mnt:[4026532323]] nsfs        rw
```
...
tmpfs          tmpfs     2.2G  1.5M  2.2G   1% /run
/dev/nvme0n1p2 ext4      233G  8.4G  213G   4% /
tmpfs          tmpfs     5.5G     0  5.5G   0% /dev/shm
efivarfs       efivarfs  150K   88K   57K  61% /sys/firmware/efi/efivars
...
Fri 2026-09-04 23:03:34 UTC 1min 31s Thu 2026-09-03 06:41:42 UTC            - logrotate.timer                logrotate.service
Fri 2026-09-04 23:10:00 UTC     7min Fri 2026-09-04 23:00:14 UTC 1min 48s ago sysstat-collect.timer          sysstat-collect.service
Fri 2026-09-04 23:11:18 UTC     9min -                                      - systemd-tmpfiles-clean.timer   systemd-tmpfiles-clean.service
Fri 2026-09-04 23:24:24 UTC    22min Thu 2026-09-03 06:41:42 UTC            - apt-daily-upgrade.timer        apt-daily-upgrade.service
Fri 2026-09-04 23:45:19 UTC    43min Thu 2026-09-03 06:41:42 UTC            - fwupd-refresh.timer            fwupd-refresh.service
Sat 2026-09-05 00:00:00 UTC    57min Fri 2026-09-04 22:56:25 UTC     5min ago dpkg-db-backup.timer           dpkg-db-backup.service
Sat 2026-09-05 00:00:00 UTC    57min -                                      - sysstat-rotate.timer           sysstat-rotate.service
Sat 2026-09-05 00:07:00 UTC  1h 4min -                                      - sysstat-summary.timer          sysstat-summary.service
Sat 2026-09-05 00:14:03 UTC 1h 12min Thu 2026-09-03 06:41:42 UTC            - man-db.timer                   man-db.service
Sat 2026-09-05 02:48:37 UTC 3h 46min Thu 2026-09-03 06:41:42 UTC            - apt-daily.timer                apt-daily.service
Sat 2026-09-05 03:51:43 UTC 4h 49min Thu 2026-09-03 06:41:42 UTC            - motd-news.timer                motd-news.service
Sat 2026-09-05 23:01:38 UTC      23h Fri 2026-09-04 23:01:38 UTC      24s ago update-notifier-download.timer update-notifier-download.service
Sun 2026-09-06 03:10:09 UTC 1 day 4h Thu 2026-09-03 06:41:42 UTC            - e2scrub_all.timer              e2scrub_all.service
Sun 2026-09-06 03:10:39 UTC 1 day 4h Thu 2026-09-03 06:41:42 UTC            - xfs_scrub_all.timer            xfs_scrub_all.service
Mon 2026-09-07 01:21:17 UTC   2 days Thu 2026-09-03 06:41:42 UTC            - fstrim.timer                   fstrim.service
Thu 2026-09-10 22:49:00 UTC   5 days Thu 2026-09-03 06:41:42 UTC            - update-notifier-motd.timer     update-notifier-motd.service
...
udp   UNCONN 0      0      192.168.0.10%eno1:68        0.0.0.0:*          
